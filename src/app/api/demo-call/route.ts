  ...
  try {
    ...
    const payload = {
      arguments: [
        {
          name: "content",
          value: `Call ${body.name} in ${body.industry} industry at ${body.phone}. Greet the user: 'Hey! This is Axel from ActivateAI! Is this ${body.name}?'. Once user confirms, start scenario: **Outbound Call**.`
        }
      ]
    };
