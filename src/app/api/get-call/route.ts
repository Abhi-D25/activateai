...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Prepare webhook payload as specified by user
    const payload = {
      arguments: [
        {
          name: "content",
          value: `Call ${body.name} at ${body.phone}. Greet the user: 'Hey ${body.name}! This is Axel from ActivateAI! What would you like to know more about?'. Once user confirms, start **Scenario 21:** "Outbound Call to User".`
        }
      ]
    };
