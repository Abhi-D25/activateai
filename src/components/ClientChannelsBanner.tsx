...
const channels = [
    ...
    { name: 'SMS', icon: DevicePhoneMobileIcon, color: 'text-green-400' },
    { name: 'WhatsApp', icon: ChatBubbleOvalLeftEllipsisIcon, color: 'text-green-500' },
    { name: 'Instagram', icon: CameraIcon, color: 'text-pink-500' },
    { name: 'TikTok', icon: GlobeAltIcon, color: 'text-black dark:text-white' },
    { name: 'Telegram', icon: PaperAirplaneIcon, color: 'text-blue-500' },
