                ...
                <div className="mt-8 pt-8 border-t border-slate-800 hidden md:flex justify-end items-center">
                  ...
                  {hasDemo && (
                    <Link
                      ...
                      onClick={onClose}
                      className="px-6 py-2 bg-transparent border-2 border-blue-500 text-blue-400 hover:bg-blue-500/10 rounded-lg font-semibold transition-colors mr-4 inline-flex items-center"
                    >
                ...
                <div className="flex flex-col gap-3">
                  {hasDemo && (
                    <Link
                      href={`/solutions?demo=${demoParam}`}
                      onClick={onClose}
                      className="px-6 py-2 bg-transparent border-2 border-blue-500 text-blue-400 hover:bg-blue-500/10 rounded-lg font-semibold transition-colors inline-flex items-center justify-center"
                    >
                      <PlayIcon className="w-5 h-5 mr-2" />
                      Try it Yourself
                    </Link>
